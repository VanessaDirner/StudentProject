namespace StudentWindowsFormsApp.Views.departmentCollectionView {
    partial class departmentCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.ribbonPageGroup1.Text = "department Tasks";
			...
			this.departmentCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.departmentCollectionViewBindingSource.DataSource = typeof(StudentWindowsFormsApp.department);
			this.gridControl.DataSource = departmentCollectionViewBindingSource;
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters assignmentsPopulateColumnParameters_NotVisible = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            assignmentsPopulateColumnParameters_NotVisible.FieldName = "assignments";
		    assignmentsPopulateColumnParameters_NotVisible.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(assignmentsPopulateColumnParameters_NotVisible);
			 
			this.gridView.PopulateColumns(typeof(StudentWindowsFormsApp.department),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(StudentWindowsFormsApp.ViewModels.departmentCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(StudentWindowsFormsApp.ViewModels.departmentCollectionViewModel), "New", bbiNew));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(StudentWindowsFormsApp.ViewModels.departmentCollectionViewModel), "Edit", "SelectedEntity", bbiEdit));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(StudentWindowsFormsApp.ViewModels.departmentCollectionViewModel), "Delete", "SelectedEntity", bbiDelete));
					this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(StudentWindowsFormsApp.ViewModels.departmentCollectionViewModel), "Refresh", bbiRefresh));
            ...
            this.Name = "departmentCollectionView";
		...
		private System.Windows.Forms.BindingSource departmentCollectionViewBindingSource;
