namespace StudentWindowsFormsApp.Views.departmentView {
    partial class departmentView {
		...
		private void InitializeComponent() {
            ...
            this.mainRibbonPageGroup.Text = "department Tasks";
			// 
			...
			this.departmentViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.departmentViewBindingSource.DataSource = typeof(StudentWindowsFormsApp.department);
			this.dataLayoutControl1.DataSource = departmentViewBindingSource;
			//
			//Create GridControls
			//
            ...
            this.mvvmContext.ViewModelType = typeof(StudentWindowsFormsApp.ViewModels.departmentViewModel);
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(StudentWindowsFormsApp.ViewModels.departmentViewModel), "Save", bbiSave));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(StudentWindowsFormsApp.ViewModels.departmentViewModel), "SaveAndClose", bbiSaveAndClose));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(StudentWindowsFormsApp.ViewModels.departmentViewModel), "SaveAndNew", bbiSaveAndNew));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(StudentWindowsFormsApp.ViewModels.departmentViewModel), "Reset", bbiReset));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(StudentWindowsFormsApp.ViewModels.departmentViewModel), "Delete", bbiDelete));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(StudentWindowsFormsApp.ViewModels.departmentViewModel), "Close", bbiClose));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(StudentWindowsFormsApp.ViewModels.departmentViewModel), "SaveLayout", bbiSaveLayout));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(StudentWindowsFormsApp.ViewModels.departmentViewModel), "ResetLayout", bbiResetLayout));
		...
		private System.Windows.Forms.BindingSource departmentViewBindingSource;
