...
namespace StudentWindowsFormsApp.Views.departmentCollectionView{
    public partial class departmentCollectionView : XtraUserControl {
        ...
        void InitBindings() {
            ...
            var fluentAPI = mvvmContext.OfType<StudentWindowsFormsApp.ViewModels.departmentCollectionViewModel>();
            ...
            fluentAPI.WithEvent<GridView, FocusedRowObjectChangedEventArgs>(gridView, "FocusedRowObjectChanged")
                .SetBinding(x => x.SelectedEntity,
                    args => args.Row as StudentWindowsFormsApp.department,
