namespace StudentWindowsFormsApp.Views.employeeCollectionView {
    partial class employeeCollectionView {
		...
		private void InitializeComponent() {
            ...
            this.ribbonPageGroup1.Text = "employee Tasks";
			...
			this.employeeCollectionViewBindingSource.DataSource = typeof(StudentWindowsFormsApp.employee);
			...
			this.gridView.PopulateColumns(typeof(StudentWindowsFormsApp.employee),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(StudentWindowsFormsApp.ViewModels.employeeCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(StudentWindowsFormsApp.ViewModels.employeeCollectionViewModel), "New", bbiNew));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(StudentWindowsFormsApp.ViewModels.employeeCollectionViewModel), "Edit", "SelectedEntity", bbiEdit));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(StudentWindowsFormsApp.ViewModels.employeeCollectionViewModel), "Delete", "SelectedEntity", bbiDelete));
					this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(StudentWindowsFormsApp.ViewModels.employeeCollectionViewModel), "Refresh", bbiRefresh));
