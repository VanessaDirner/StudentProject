...
namespace StudentWindowsFormsApp.Views.assignmentCollectionView{
    public partial class assignmentCollectionView : XtraUserControl {
        public assignmentCollectionView() {
            InitializeComponent();
        ...
        void InitBindings() {
            ...
            var fluentAPI = mvvmContext.OfType<StudentWindowsFormsApp.ViewModels.assignmentCollectionViewModel>();
